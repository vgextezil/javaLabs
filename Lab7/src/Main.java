...
public class Main implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        try(ObjectInputStream objectInputStream = new ObjectInputStream(new FileInputStream("Dishes.json"))){
            dishes = ((ArrayList<Dishes>)objectInputStream.readObject());
        }
        ...
        try(ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream("Dishes.json"))){
